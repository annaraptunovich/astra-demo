      ...
      <main className="ml-[220px] flex-1 max-w-[960px] px-10 py-10 flex flex-col gap-14">
        ...
        <div>
          ...
          <p className="text-[15px] text-text-secondary mt-2 max-w-[600px]">
            Component and token inventory for the local Astra design system. Use this overview to assess design system completeness and guide the authoring of usage guidelines.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              ...
              <ul className="text-[12px] text-emerald-700 list-disc pl-4 space-y-1">
                ...
                <li>Private Vite app setup with reusable local component APIs</li>
              ...
              <table className="w-full text-[12px]">
                ...
                <tbody className="text-emerald-700">
                  ...
                  <tr className="border-t border-emerald-200">
                    ...
                    <td>Guideline files authored in <code>guidelines/</code> for local app and Figma Make transfer</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <footer className="text-[11px] text-text-tertiary pt-4 pb-8 border-t border-border-secondary">
          Astra Design System Overview &middot; Local app &middot; Generated {new Date().toLocaleDateString()}
        </footer>
      </main>
    </div>
  )
